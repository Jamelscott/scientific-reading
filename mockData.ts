...
export const mockApiData = {
  ...
  evaluations: [
    ...
    // Class 3 evaluations
    {
      ...
      studentId: 4,
      classId: 3,
      evaluations: ["adequate", "adequate", "success", "adequate", null, null, null, null, null, null],
    },
    {
      id: 17,
      studentId: 12,
      classId: 3,
      evaluations: ["needs-improvement", "adequate", "adequate", "success", "adequate", null, null, null, null, null],
    },
    {
      id: 18,
      studentId: 14,
      classId: 3,
      evaluations: ["success", "success", "adequate", "success", "success", "success", null, null, null, null],
    },
    {
      id: 19,
      studentId: 15,
      classId: 3,
      evaluations: ["adequate", "success", "adequate", "adequate", "success", null, null, null, null, null],
    },
  ] as MockEvaluation[],
